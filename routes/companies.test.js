...
describe("GET /companies", function () {
  ...
  test("ok for filtering name, minEmployees, maxEmployees", async function () {
  ...
  test("bad request for minEmployees > maxEmployees", async function () {
